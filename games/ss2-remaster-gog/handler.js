...
Game.Description = "GOG 1.3. Two gamepads, top/bottom split; controller isolation and LAN connection confirmed by human testing. Multiplayer > LAN: host on one side; join 127.0.0.1 on the other. Made with AI assistance (OpenAI Codex). Unofficial community handler. Source and updates: https://github.com/alex-nax/coop/tree/main/games/ss2-remaster-gog";
Game.MaxPlayers = 2;
